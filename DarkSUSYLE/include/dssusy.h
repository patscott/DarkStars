...
* useful global variables + roption
      integer lsp,kln
*pat-pi
      real*8 s2thw,sinthw,costhw,cosbe,sinbe,
     & cos2be,sin2be,zg,lgzg,delrho,alph3mz
      character*5 roption
      common /iuseful/ lsp,kln
*pat-pi
      common /ruseful/ s2thw,sinthw,costhw,
...
* mass spectrum
      ...
      common /mspctm/ mass,mcmc,mbmb,mtmt
